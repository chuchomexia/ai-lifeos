...
Copia y pega el siguiente prompt en tu LLM favorito (Claude, ChatGPT) o IDE con IA (Cursor, Windsurf, Cline) para que te asista a rellenar tus archivos locales paso a paso.

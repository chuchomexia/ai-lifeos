# LifeOS — Prompt de Espacio de Trabajo (Workspace)

## Objetivo

Quiero crear un espacio de trabajo/proyecto para mi asistente llamado **LifeOS** en esta plataforma (ChatGPT, Claude, Gemini, etc.). Para lograrlo, necesito que me hagas todas las preguntas necesarias hasta que tengas un entendimiento profundo de lo que busco. Con esa información, crearemos juntos las instrucciones base (system prompt) de este proyecto.
...
Existe un análisis detallado en `context/self-analysis.md` que contiene:
